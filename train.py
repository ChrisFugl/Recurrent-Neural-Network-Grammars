...
def _main(config):
    ...
    iterator_train = get_iterator(device, *iterator_converters, tokens_train, unknownified_tokens_train, actions_train, tags_train, config.iterator)
    iterator_val_config = deepcopy(config.iterator)
    iterator_val_config.shuffle = False
    iterator_val = get_iterator(device, *iterator_converters, unknownified_tokens_val, unknownified_tokens_val, actions_val, tags_val, iterator_val_config)
